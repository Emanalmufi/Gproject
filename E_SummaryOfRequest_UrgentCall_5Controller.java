 ...
 * @author hp
 */
public class E_SummaryOfRequest_UrgentCall_5Controller implements Initializable {
   private Stage stage;
   private Scene scene;
   private Parent root;
    /**
    ...
    //aoudio call btn 
      @FXML
      public void MakeAoudioCall(ActionEvent event) throws IOException{

      Parent root = FXMLLoader.load(getClass().getResource("E_AudioAcceptenceMessege.fxml"));
   ...
   //video call btn   
        @FXML
      public void MakeVideoCall(ActionEvent event) throws IOException{

      Parent root = FXMLLoader.load(getClass().getResource("E_VideoAcceptenceMessege.fxml"));
      scene  = new Scene(root); 
      stage  = (Stage)((Node)event.getSource()).getScene().getWindow();
      stage.setScene(scene);
      stage.show();

 ...
 * @author hp
 */
public class E_UrgentCallController implements Initializable {
    ...
    @FXML
    private void GoToAcceptVM(ActionEvent event) throws IOException {
     
     Parent root = FXMLLoader.load(getClass().getResource("E_VideoCallAcceptenceMessege.fxml"));
        ...
        @FXML
    private void GoToAcceptAM(ActionEvent event) throws IOException {
       
        Parent root = FXMLLoader.load(getClass().getResource("E_AudioCallAcceptenceMessege.fxml"));
        scene  = new Scene(root); 
        stage  = (Stage)((Node)event.getSource()).getScene().getWindow();
        stage.setScene(scene);
        stage.show();
